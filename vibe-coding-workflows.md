...
Artifacts:
- PRD: context/PRD.md
- TECH_DESIGN: context/ARCHITECTURE.md
...
| **ARCHITECTURE.md** | Architecture, data models, integration points | Per major change |
...
Inputs:
- Vibe Brief: {attached}
- Relevant excerpts from PRD.md and ARCHITECTURE.md
...
- Invariants/business rules: {from PRD/ARCHITECTURE.md/NOTES}
...
- If context may be missing, ask for: PRD.md, ARCHITECTURE.md, NOTES.md, CHANGELOG.md.
- **CIRCUIT BREAKER:** If you fail a test or build 3 times in a row, STOP and escalate to the human. Do not get stuck in an infinite loop.
```
...
## Advanced Specialized Playbooks
